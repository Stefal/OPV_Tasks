...
tasks = ["makeall", "rotate", "cpfind", "autooptimiser", "panomodify", "stitchable", "stitch", "photosphere", "tiling", "injectcpapn", "findnearestcp", "webgen", "pathfinder", "osfmextract", "osfmall", "osfmsave", "osfmlaunch", "osfmcampaign", "exportviewer"]

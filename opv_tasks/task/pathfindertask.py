...
class PathfinderTask(Task):
    ...
    def runWithExceptions(self, options={}):
        ...
        # path_detailed.id_path_details = 1

        path_detailed.id_campaign = campaign_id
        path_detailed.id_campaign_malette = malette_id
        ...
        id_path_details = toto["id_path_details"]
        path_detailed.save()
        ...
        for name, nodes in final_graphe.nodes.items():
            ...
            transco_table[name] = path_node.id_path_node

            path_node.id_panorama = int(name)
            path_node.id_panorama_malette = malette_id
            path_node.id_path_details = id_path_details
            path_node.id_path_details_malette = malette_id
            ...
            if name == final_graphe.path[0]:
                path_detailed.id_start_node = int(path_node.id_path_node)
                path_detailed.id_start_node_malette = campaign_id
                path_detailed.save()
            if name == final_graphe.path[-1]:
                path_detailed.id_stop_node = int(path_node.id_path_node)
                path_detailed.id_stop_node_malette = campaign_id
                path_detailed.save()
        ...
        for name, edge in final_graphe.edges.items():
            ...
            path_edge.id_path_details = id_path_details
            path_edge.id_path_details_malette = malette_id
            path_edge.source_id_path_node = transco_table[name]
            path_edge.source_id_path_node_malette = malette_id
            path_edge.dest_id_path_node = transco_table[name]
            path_edge.dest_id_path_node = malette_id
